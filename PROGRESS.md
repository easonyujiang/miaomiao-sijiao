...
- [x] **服务器部署** — ✅ 已完成：`git pull` + systemd 服务配置 + 2 workers 运行
- [x] **社区种子数据** — ✅ 已完成：8 个话题 + 12 条回复
- [x] **CORS 配置** — ✅ 已修复：`EWA_CORS_ORIGINS` 包含 `http://8.130.190.169:8000`
- [ ] **阿里云安全组** — 确认 8000 端口入站 TCP 已放行（服务器内访问正常）
